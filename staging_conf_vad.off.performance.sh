...
date;time test.py -p conf_staging_log_server_log_only | hstarter_ReportPerfomance_2_table.awk | hstarter_ReportPerfomance_2_table_2_db.py --test_server=staging --test_mode=vad.off;date
